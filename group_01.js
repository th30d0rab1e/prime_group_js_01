...
/*console.log(bonus(atticus));
console.log(bonus(jem));
console.log(bonus(boo));
console.log(bonus(scout));
console.log(bonus(robert));
console.log(bonus(mayella));*/
